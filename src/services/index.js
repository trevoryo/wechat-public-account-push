...
export const getAggregatedData = async () => {
  ...
  for (const user of users) {
    ...
    const wxTemplateParams = [
      { name: toLowerLine('toName'), value: user.name, color: colors },
      {
        name: toLowerLine('date'),
        value: `${selfDayjs().format('YYYY-MM-DD')} ${weekList[selfDayjs().format('d')]}`,
        color: getColor(),
      },
      { name: toLowerLine('province'), value: user.province || config.PROVINCE, color: colors },
      { name: toLowerLine('city'), value: user.city || config.CITY, color: colors },
      { name: toLowerLine('birthdayMessage'), value: birthdayMessage, color: colors },
      { name: toLowerLine('noteEn'), value: noteEn, color: colors },
      { name: toLowerLine('noteCh'), value: noteCh, color: colors },
      { name: toLowerLine('holidaytts'), value: holidaytts, color: colors },
      { name: toLowerLine('oneTalk'), value: oneTalk, color: colors },
      { name: toLowerLine('talkFrom'), value: talkFrom, color: colors },
      { name: toLowerLine('earthyLoveWords'), value: earthyLoveWords, color: colors },
      { name: toLowerLine('momentCopyrighting'), value: momentCopyrighting, color: colors },
      { name: toLowerLine('poisonChickenSoup'), value: poisonChickenSoup, color: colors },
      { name: toLowerLine('poetryContent'), value: poetryContent, color: colors },
      { name: toLowerLine('poetryAuthor'), value: poetryAuthor, color: colors },
      { name: toLowerLine('poetryDynasty'), value: poetryDynasty, color: colors },
      { name: toLowerLine('poetryTitle'), value: poetryTitle, color: colors },
      { name: toLowerLine('courseSchedule'), value: courseSchedule, color: colors },
...
export const getCallbackTemplateParams = (messageReply) => {
  ...
  return [
    { name: toLowerLine('postTimeZone'), value: postTimeZone, color: colors },
    { name: toLowerLine('postTime'), value: postTime, color: colors },
    { name: toLowerLine('needPostNum'), value: messageReply.needPostNum, color: colors },
    { name: toLowerLine('successPostNum'), value: messageReply.successPostNum, color: colors },
    { name: toLowerLine('failPostNum'), value: messageReply.failPostNum, color: colors },
    { name: toLowerLine('successPostIds'), value: messageReply.successPostIds, color: colors },
    { name: toLowerLine('failPostIds'), value: messageReply.failPostIds, color: colors },
  ]
}
